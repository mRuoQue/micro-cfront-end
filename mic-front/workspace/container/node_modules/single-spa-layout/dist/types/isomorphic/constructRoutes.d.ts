...
export type RoutesConfig = Element | import("parse5").DefaultTreeDocument | InputRoutesConfigObject;
...
export type RouteChild = Node | Application | UrlRoute;
export type ResolvedRouteChild = Node | ResolvedUrlRoute | Application;
...
export type HTMLLayoutData = {
    ...
    errors?: {
        [key: string]: string | singleSpa.ParcelConfigObject | (() => Promise<singleSpa.ParcelConfigObject>);
    };
};
